...
public class SupplierController {
	...
	public String addSupplier(@ModelAttribute("supplier") Supplier supplier) {
		...
		if (supplierDAO.get(supplier.getSupr_id()) == null) {
	...
	@RequestMapping(value= "supplier/update/{supr_id}")
	public String updateCategory(@PathVariable("supr_id") String id ) {
		...
		//String id=supplier.getId();
		 supplier=supplierDAO.get(id);
			System.out.println(supplier.getSupr_id());
	...
	@RequestMapping("/supplier/remove/{supr_id}")
	public String deletesupplier(@PathVariable("supr_id") String id) throws Exception {
