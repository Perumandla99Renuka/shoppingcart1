...
/*                  Category category=categoryDAO.getByName(product.getCategory().getCat_name());
     ...
     /*          product.setCategory_id(category.getCat_id());
              ...
              if (productDAO.get(product.getProt_id()) == null) {
	...
	@RequestMapping("product/remove/{prot_id}")
	public String removeProduct(@PathVariable("prot_id") String id)
	{
	...
	@RequestMapping("product/edit/{prot_id}")
	public String removeProduct(@PathVariable("prot_id") String id,Model model){
	...
	/*@RequestMapping("product/get/{prot_id}")
	public String getSelectedProduct(@PathVariable("prot_id") String id,Model model,
