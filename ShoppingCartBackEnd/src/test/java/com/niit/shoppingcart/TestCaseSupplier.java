...
public class TestCaseSupplier {
	...
	{
		supplier.setSupr_id("003");
		supplier.setSupr_name("SUN");
		supplier.setSupr_address("this macro");
	...
	public void deleteTestCase(){
		supplier.setSupr_id("MOB_002");
		assertEquals(supplierDAO.delete(supplier),true);
	}*/
	
/*	@Test
	public void updateTestCase(){
		supplier.setSupr_id("SUP_001");
		supplier.setSupr_name("Micro");
		supplier.setSupr_address("this is micro");
